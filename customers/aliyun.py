...
def send1():
    ...
    print __business_id
    params = "{\"code\":\"12345\",\"product\":\"云通信\"}"
    print send_sms(__business_id, "18813090664", "云通信测试", "SMS_5250008", params)
def query1():
    print query_send_detail("1234567^8901234", "18813090664", 10, 1, "20170612")